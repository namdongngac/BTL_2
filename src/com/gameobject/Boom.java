...
public class Boom extends Object{
    ...
    public Boom(float posX, float posY, float w, float h, GameWorld gw, int range) {
        ...
        exSound = CacheDataLoader.getInstance().getSound("bombSound");
    }
    ...
    public void explosive(){
        ...
        if(System.nanoTime() - timeBeginExplosive > timeForExplosive){
            ...
            for(int i = 0; i < range; i++){
                Rectangle rectU = new Rectangle((int)getPosX()-30,(int)getPosY() - getGameWorld().pMap.getTileSize()*(i+1)-30, 60, 60);
            ...
            // DOWN FLAME
            for(int i = 0; i < range; i++){
                Rectangle rectD = new Rectangle((int)getPosX()-30,(int)getPosY() + getGameWorld().pMap.getTileSize()*(i+1)-30, 60, 60);
            ...
            // LEFT FLAME
            for(int i = 0; i < range; i++){
                Rectangle rectL = new Rectangle((int)getPosX()- getGameWorld().pMap.getTileSize()*(i+1)-30,(int)getPosY()-30 , 60, 60);
            ...
            for(int i = 0; i < range; i++){
                ...
                Rectangle rectR = new Rectangle((int)getPosX()+ getGameWorld().pMap.getTileSize()*(i+1)-30,(int)getPosY()-30 , 60, 60);
